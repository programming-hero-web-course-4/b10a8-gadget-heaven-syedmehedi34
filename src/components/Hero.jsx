...
const Hero = () => {
  return (
    <div className="relative mb-64 ">
      ...
      <div className="rounded-[24px] w-[70%]  flex items-center justify-center absolute transform -translate-y-1/2 left-1/2 -translate-x-1/2 bg-white-1/3 backdrop-blur-2xl">
